  ...
  return (
    <BaseTestingPage pageTitle="Map Configuration">
      <div>
        ...
        <IonButton id="moveCameraButton" onClick={moveCameras}>
          Move Camera
        </IonButton>
        <IonButton id="setMapTypeButton" onClick={setMapType}>
          Set Map Type
        </IonButton>
        <IonButton id="enableIndoorMapButton" onClick={enableIndoorMaps}>
          Enable Indoor Maps
        </IonButton>
        <IonButton id="enableTrafficButton" onClick={enableTrafficLayer}>
          Enable Traffic Layer
        </IonButton>
        <IonButton id="disableTrafficButton" onClick={disableTrafficLayer}>
          Disable Traffic Layer
        </IonButton>
        <IonButton id="showLocationButton" onClick={showCurrentLocation}>
          Show Current Location
        </IonButton>
        <IonButton id="hideLocationButton" onClick={hideCurrentLocation}>
          Hide Current Location
        </IonButton>
        <IonButton
          id="showAccessibilityButton"
          onClick={showAccessibilityElements}
        >
          Show Acc. Elements
        </IonButton>
        <IonButton
          id="hideAccessibilityButton"
          onClick={hideAccessibilityElements}
        >
          Hide Acc. Elements
        </IonButton>
      </div>
